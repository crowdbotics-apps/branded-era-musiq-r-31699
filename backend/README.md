...
## Project Structure
    ...
    ├── branded_era_musiq_r_31699  # Django project configurations
...
1. Clone this repo and `cd branded_era_musiq_r_31699`
...
2. Clone this repo and `cd branded_era_musiq_r_31699`
